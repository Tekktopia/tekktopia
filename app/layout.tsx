...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Tekktopia — Building That Builds Your Business" }],
  },
  twitter: {
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return (
    <html lang="en" suppressHydrationWarning className={`${spaceGrotesk.variable} ${inter.variable} ${jetbrainsMono.variable} overflow-x-hidden`}>
      <head>
      <script
